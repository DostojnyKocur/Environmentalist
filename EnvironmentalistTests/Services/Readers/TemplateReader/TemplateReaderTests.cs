...
namespace EnvironmentalistTests.Services.Readers.TemplateReader
{
    [TestFixture]
    public class TemplateReaderTests
    {
        ...
        private TemplateModel EnvVarConfigurationModel;
        ...
        private ITemplateReader _sut;

        [SetUp]
        public void Init()
        {
            EnvVarConfigurationModel = new TemplateModel();
            ...
            _sut = new Environmentalist.Services.Readers.TemplateReader.TemplateReader(
