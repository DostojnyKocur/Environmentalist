...
namespace EnvironmentalistTests.Services.Repositories.ProfileRepository
{
    [TestFixture]
    public class ProfileRepositoryTests
    {
        ...
        public void Init()
        {
            ...
            _sut = new Environmentalist.Services.Repositories.ProfileRepository.ProfileRepository(
